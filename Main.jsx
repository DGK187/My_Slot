...
const symbols = ["💎", "🪨", "🏆", "🥈", "💲", "💰"]; const reelsCount = 5; const rowsCount = 3;

const getRandomSymbol = () => symbols[Math.floor(Math.random() \* symbols.length)];

export default function SlotMachine() { const [reels, setReels] = useState( Array.from({ length: reelsCount }, () => Array.from({ length: rowsCount }, getRandomSymbol) ) ); const [spinning, setSpinning] = useState(false); const [bonusActive, setBonusActive] = useState(false);
